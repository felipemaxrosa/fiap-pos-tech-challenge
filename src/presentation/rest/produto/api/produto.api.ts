...
import { BuscaPorIdProdutoResponse } from 'src/presentation/rest/produto/response/busca-por-id-produto.response';
import { BuscaTodosPorIdCategoriaProdutoResponse } from 'src/presentation/rest/produto/response/busca-todos-por-id-categoria-produto.response';
import { EditarProdutoResponse } from 'src/presentation/rest/produto/response/editar-produto.response';
...
@ApiTags('Produto')
export class ProdutoRestApi extends BaseRestApi {
   private logger: Logger = new Logger(ProdutoRestApi.name);
