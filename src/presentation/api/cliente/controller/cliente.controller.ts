...
import { BuscarPorCpfClienteRequest } from 'src/presentation/api/cliente/request/buscar-por-cpf-cliente.request';
import { IdentificarPorCpfClienteRequest } from 'src/presentation/api/cliente/request/identificar-por-cpf-cliente.request';
import { SalvarClienteRequest } from 'src/presentation/api/cliente/request/salvar-cliente.request';
import { BuscarPorCpfClienteResponse } from 'src/presentation/api/cliente/response/buscar-por-cpf-cliente.response';
import { IdentificarPorCpfClienteResponse } from 'src/presentation/api/cliente/response/identificar-por-cpf-cliente.response';
import { SalvarClienteResponse } from 'src/presentation/api/cliente/response/salvar-cliente.response';
